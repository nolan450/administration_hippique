 ...
 */
final class Version20230328230317 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE joueur ADD centre_equestre_id INT DEFAULT NULL, CHANGE desciption description VARCHAR(255) NOT NULL, CHANGE date_inciption date_inscription DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE joueur DROP centre_equestre_id, CHANGE description desciption VARCHAR(255) NOT NULL, CHANGE date_inscription date_inciption DATETIME NOT NULL');
    }
}
